        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <label className="text-sm">
            ...
            <div className="flex items-center gap-3">
              <label className="inline-flex items-center gap-2 cursor-pointer bg-linear-to-r from-emerald-500 to-green-600 text-white px-4 py-2 rounded-lg shadow hover:from-emerald-600 hover:to-green-700 transition">
          ...
          <div className="flex gap-3 pt-4">
            <button type="submit" className="px-6 py-3 bg-linear-to-r from-emerald-500 to-green-600 text-white rounded-lg shadow-lg hover:from-emerald-600 hover:to-green-700 font-semibold transition">Save</button>
