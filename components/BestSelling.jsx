...
const BestSelling = () => {
    ...
    return (
        <div className='px-3 sm:px-6 my-8 sm:my-10 max-w-6xl mx-auto'>
            ...
            <div className='mt-8 sm:mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6 xl:gap-12'>
