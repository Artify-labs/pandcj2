...
const Newsletter = () => {
    ...
    return (
        <div className='flex flex-col items-center mx-4 my-15'>
            <Title title="Our Family" description="Subscribe to get exclusive deals, new arrivals, and insider updates delivered straight to your inbox on release." visibleButton={false} />
