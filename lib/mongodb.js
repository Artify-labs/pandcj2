...
// Export a standard getClient function for all routes to use
export async function getMongoClient() {
  ...
  if (globalForMongo._mongoClient && globalForMongo._mongoClient.topology) {
    try {
      ...
      console.warn('[MongoDB] Connection ping failed, recreating...', e.message)
...
export const mongodb = {
  ...
  store: {
    ...
    async update(id, data) {
      ...
      // MongoDB driver returns result object directly
      return result
    },
  ...
  product: {
    ...
    async update(id, data) {
      ...
      // MongoDB driver returns result object directly, not wrapped in { value: ... }
      return result
    },
